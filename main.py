...
from datetime import datetime # providing date and time (UTC) 
...
for league in LEAGUES:
    url = f"https://api.football-data.org/v2/matches?competitions={league}&dateFrom={today_str}&dateTo={today_str}"
    ...
    try:
        ...
        # Keep only matches that are still upcoming
        upcoming_matches = []
